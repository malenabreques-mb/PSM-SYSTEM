...
namespace PSMSystem.Migrations
{
    ...
    [Migration("20260914223823_BusquedaSinTildes")]
            ...
            modelBuilder.Entity("PSMSystem.Models.DetalleFactura", b =>
                {
                    ...
                    b.ToTable("DetalleFactura", null, t =>
                        {
                            t.HasCheckConstraint("CK_DetalleFactura_TipoItem", "[tipo_item] IN ('Repuesto', 'Mano de obra')");
                        });
                });
            ...
            modelBuilder.Entity("PSMSystem.Models.DetallePresupuesto", b =>
                {
                    ...
                    b.ToTable("DetallePresupuesto", null, t =>
                        {
                            t.HasCheckConstraint("CK_DetallePresupuesto_TipoItem", "[tipo_item] IN ('Repuesto', 'Mano de obra')");
                        });
                });
